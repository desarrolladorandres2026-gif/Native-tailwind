...
const { obtenerMensajes, enviarMensaje, subirImagen, eliminarConversacion } = require('../controllers/chat.controller');
...
router.delete('/:userId', eliminarConversacion);  // DELETE /api/chat/:userId
