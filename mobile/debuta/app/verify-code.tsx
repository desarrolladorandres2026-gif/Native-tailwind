// verify-code.tsx — Debuta: Pantalla de Verificación de Código
...
export default function VerifyCodeScreen() {
  ...
  const handleVerify = async () => {
    ...
    setLoading(true);
    try {
      await api.post('/password/verify', { correo, code });
        ...
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'padding'}>
          <Animated.View style={[s.container, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            ...
            <View style={s.header}>
              ...
              <Text style={s.heading}>Verifica tu correo</Text>
            ...
            <View style={s.card}>
              ...
              <View>
                ...
                <View style={s.inputWrap}>
                  <Ionicons name="key-outline" size={19} color={C.secondary} />
                  <TextInput
                    style={s.input}
                    placeholder="123456"
                    placeholderTextColor={C.textLight}
                    value={code}
                    onChangeText={v => { setError(null); setCode(v.replace(/[^0-9]/g, '').slice(0, 6)); }}
              ...
              <TouchableOpacity style={{ alignItems: 'center' }} onPress={() => router.back()}>
                <Text style={s.switchText}>
                  ...
                  <Text style={s.switchLink}>Reintentar</Text>
                </Text>
              </TouchableOpacity>
